...
<details>
  ...
  <ol>
    <blockquote>
      <p><strong>NOTE:</strong> All generated files are rootless, except for the YTPlus .deb, which is rootful (arm64). If you need a rootless version, please convert it using Derootifier.</p>
    </blockquote>
    <li>If you already have a fork of MY repository YTPlusM, click on <strong>Sync fork</strong>, and if your branch is out-of-date, click on <strong>Update branch</strong>.</li>
...
<p><strong>Old secondary repository for building YTPlusM IPAs with GitHub Actions (deleted);
